  ...
  return (
    <form action={formAction} className="flex flex-col gap-2">
      <textarea
        ...
        spellCheck={false}
        className="rounded-lg border border-line-strong bg-surface px-3 py-2 font-mono text-xs outline-none focus:border-accent"
      />
      <button
        type="submit"
        disabled={pending}
        className="self-start rounded-lg bg-accent text-white px-3 py-1.5 text-sm font-semibold hover:bg-accent-strong disabled:opacity-50"
      >
